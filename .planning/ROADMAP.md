...
| 1.3 MSW Handlers | Mock `/api/flows/{id}/trace` endpoint with deterministic trace responses. | 1.1 |
...
**Goal:** The debugging UX comes alive — step-by-step evaluation log, path highlight on canvas, contact selector, "Run Trace" wiring.
...
**Goal:** The killer differentiator — per-condition split evaluation popover. Sample templates, edge case handling, final polish.
...
| 3: Split Popover & Polish | ○ | 4 | 3 |
| **Total** | | **18** | **12** |

---
*Roadmap created: 2026-08-03*
*Last updated: 2026-08-03 after initial creation*
